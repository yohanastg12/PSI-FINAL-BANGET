            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Lesson">
                <thead>
                    <tr>
                        ...
                        <th>{{ trans('cruds.lesson.fields.class') }}</th>
                        <th>{{ trans('cruds.lesson.fields.teacher') }}</th>
                        <th>{{ trans('cruds.lesson.fields.weekday') }}</th>
                        <th>{{ trans('cruds.lesson.fields.session') }} ({{ __('Start') }})</th>
                        <th>{{ trans('cruds.lesson.fields.session') }} ({{ __('End') }})</th>
                        <th>&nbsp;</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($lessons as $key => $lesson)
                        <tr data-entry-id="{{ $lesson->id }}">
                            ...
                            <td>{{ $lesson->session->start ?? '' }}</td>
                            <td>{{ $lesson->session->end ?? '' }}</td>
                            <td>
                                @can('lesson_show')
