                                ...
                                <td>
                                    @can('school_class_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.school-classes.show', $schoolClass->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('school_class_edit')
                                        <a class="btn btn-xs btn-info"
                                            href="{{ route('admin.school-classes.edit', $schoolClass->id) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan

                                    @can('school_class_delete')
                                        <form action="{{ route('admin.school-classes.destroy', $schoolClass->id) }}"
